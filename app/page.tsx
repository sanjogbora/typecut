...
export default function Page() {
  return (
    <div className="flex flex-col min-h-screen md:h-full">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-2 md:min-h-0 overflow-y-auto md:overflow-hidden">
        <section className="w-full max-w-7xl flex items-center justify-center md:h-full">
          <FontSwitcherClient />
        </section>
      </main>
